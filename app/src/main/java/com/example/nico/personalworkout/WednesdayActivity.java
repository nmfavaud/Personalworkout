...
public class WednesdayActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_WEDNESDAYID = "id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WorkoutWednesdayFragment frag = (WorkoutWednesdayFragment)
                getSupportFragmentManager().findFragmentById(R.id.detail_frag);
        int workoutId = (int) getIntent().getExtras().get(EXTRA_WEDNESDAYID);
