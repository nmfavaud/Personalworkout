...
public class TuesdayActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_TUESDAYID = "id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WorkoutTuesdayFragment frag = (WorkoutTuesdayFragment)
                getSupportFragmentManager().findFragmentById(R.id.detail_frag);
        int workoutId = (int) getIntent().getExtras().get(EXTRA_TUESDAYID);
